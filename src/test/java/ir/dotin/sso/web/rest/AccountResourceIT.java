package ir.dotin.sso.web.rest;

import ir.dotin.sso.KamiApp;
import ir.dotin.sso.config.Constants;
import ir.dotin.sso.domain.User;
import ir.dotin.sso.repository.AuthorityRepository;
import ir.dotin.sso.repository.UserRepository;
import ir.dotin.sso.security.AuthoritiesConstants;
import ir.dotin.sso.service.UserService;
import ir.dotin.sso.service.dto.PasswordChangeDTO;
import ir.dotin.sso.service.dto.UserDTO;
import ir.dotin.sso.web.rest.vm.KeyAndPasswordVM;
import ir.dotin.sso.web.rest.vm.ManagedUserVM;
...
import static ir.dotin.sso.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = KamiApp.class)
