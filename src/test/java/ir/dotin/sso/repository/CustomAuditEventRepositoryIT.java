package ir.dotin.sso.repository;

import ir.dotin.sso.KamiApp;

import ir.dotin.sso.config.Constants;
import ir.dotin.sso.config.audit.AuditEventConverter;
import ir.dotin.sso.domain.PersistentAuditEvent;
...
import static ir.dotin.sso.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
